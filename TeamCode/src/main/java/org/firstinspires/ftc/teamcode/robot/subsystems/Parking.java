...
public class Parking extends Component {
    ...
    public Parking(HardwareMap hardwareMap, Telemetry telemetry) {
        ...
        parkLeftServo = hardwareMap.get(ServoImplEx.class, RobotProperties.parkLeftName);
        parkLeftServo.setPwmRange(new PwmControl.PwmRange(PARK_PARAMS.leftLowerBound, 2500));

        parkRightServo = hardwareMap.get(ServoImplEx.class, RobotProperties.parkRightName);
