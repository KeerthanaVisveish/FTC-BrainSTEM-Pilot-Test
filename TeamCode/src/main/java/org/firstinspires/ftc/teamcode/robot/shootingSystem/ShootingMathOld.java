...
public class ShootingMathOld {
    ...
    public static double approximateExitHeightM(boolean useHighArc) {
        double hoodAngleDeg = useHighArc ? shooterSystemParams.highArcHoodAngleDegEstimation : shooterSystemParams.lowArcHoodAngleDegEstimation;
    ...
    public static Pose2d calcTurretPose(Pose2d robotPose, double turretRelativeAngleRad) {
